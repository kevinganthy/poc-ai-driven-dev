...
Créer le fichier `.github/agents/client-<domaine>.agent.md` avec le frontmatter suivant :
...
Suivre le skill `client-template` (`.github/skills/client-template/SKILL.md`) pour le comportement complet.
```
...
2. Enregistrer dans `/memories/feedback.md` :
   ```markdown
