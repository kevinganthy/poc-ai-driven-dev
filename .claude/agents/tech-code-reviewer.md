...
**AVANT de commencer la review** — suis le skill **`sprint-resume`** (`.claude/skills/sprint-resume/SKILL.md`) :
...
Après la review, mets à jour `.github/memories/sprints/sprint_[N]_[slug].md` :
