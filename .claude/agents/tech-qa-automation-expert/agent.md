...
**AVANT d'écrire les tests** — suis le skill **`sprint-resume`** (`.claude/skills/sprint-resume/SKILL.md`) :
...
4. ✅ Alimente la todo list depuis le backlog (Todo → not-started, Done → completed)
...
Après l'écriture des tests, mets à jour `.github/memories/sprints/sprint_[N]_[slug].md` :
