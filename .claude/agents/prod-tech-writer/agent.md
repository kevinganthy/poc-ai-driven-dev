...
**AVANT d'écrire la documentation** — suis le skill **`sprint-resume`** (`.claude/skills/sprint-resume/SKILL.md`) :
...
- Cross-reference with the sprint plan (`.github/memories/sprints/sprint_[N]_[nom].md`) for acceptance criteria
...
Une fois la documentation écrite et la PR prête, mets à jour le fichier sprint actif :
