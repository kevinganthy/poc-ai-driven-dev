...
**AVANT de commencer à coder** — suis le skill **`sprint-resume`** (`.claude/skills/sprint-resume/SKILL.md`) :
...
4. ✅ Alimente la todo list depuis le backlog du sprint (Todo → not-started, Done → completed)
5. ✅ Affiche le résumé de situation avant de commencer

**À LA FIN DE CETTE SESSION** :
1. ✅ Mets à jour `.github/memories/sprints/sprint_N_*.md` avec les tâches complétées + Log d'activité
2. ✅ **Demande le feedback utilisateur** — Accepted / Modified / Rejected
3. ✅ Enregistre le feedback dans `.github/memories/feedback.md` (avec Lesson identifiée)
...
**OBLIGATION : Mettre à jour `.github/memories/sprints/sprint_N_*.md` après CHAQUE tâche ou groupe logique de tâches.**

Utiliser l'outil Edit pour :
...
1. **Demander le feedback explicitement** à l'utilisateur :
   - Options : ✅ Accepted / ⚠️ Modified / ❌ Rejected
   - Permettre commentaire libre

2. **Enregistrer dans `.github/memories/feedback.md`** après chaque réponse :
   ```markdown
...
**Patterns actuels** (lire au début de session dans `.github/memories/feedback.md`):
