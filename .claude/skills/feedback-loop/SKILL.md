---
name: feedback-loop
description: Mettre en place et utiliser un feedback loop persistant pour améliorer la qualité des suggestions de l'IA au fil du temps, en enregistrant les retours utilisateur dans la mémoire globale (`.github/memories/feedback.md`).
---
...
Avant de commencer toute tâche, lis `.github/memories/feedback.md` :
...
Une fois le retour reçu, insère une entrée dans `.github/memories/feedback.md`, dans la section **Feedback Log** :
...
## Structure du fichier `.github/memories/feedback.md`
