...
```
read_file .claude/skills/sprint-memory/template.md
```
...
Créer le fichier : `.github/memories/sprints/sprint_[N]_[slug].md`
...
- [ ] Le fichier existe dans `.github/memories/sprints/`
...
- **Toujours utiliser `.github/memories/sprints/`** comme répertoire (pas `.github/memories/` directement)
...
```
.github/memories/sprints/sprint_3_categories.md
```
